import { QueryParamsDto, Sorting, SortingParamsDto, BooleanClause, StringClause, WhereClausesDto, EnumClause } from "@maioradv/client-core";
...
export type ClausesProductDto = WhereClausesDto<{
  ...
  recurringInterval?:EnumClause<RecurringInterval>
}>
